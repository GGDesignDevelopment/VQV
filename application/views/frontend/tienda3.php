<header>
	...
	<nav id="tabs" tabindex="0">
		...
		<a class="tab" href="#" data-type="i" data-filter='["1","0","0","1","15","1"]'>Productos destacados</a>
		<a class="tab" href="#" data-type="g" data-filter='["0","0","1","1","15","1"]'>Productos a granel</a>
		<a class="tab" href="#" data-type="n" data-filter='["0","0","0","1","15","1"]'>Productos naturales</a>
		<div class="search">
...
<script type="text/javascript">
	...
	<?php if (count($categorias)): foreach ($categorias as $categoria): ?>
		categorias.push(new Categoria(
			...
			<?php echo $categoria->catdescripcion; ?>
		));
	<?php endforeach; ?>
	<?php endif; ?>
</script>
